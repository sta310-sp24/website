...
::: callout-important
Go to the [course GitHub organization](https://github.com/sta210-fa23) and locate your `ae-03` repo to get started.
...
Below are visualizatons of the distributions of daily bike rentals and temperature as well as the relationship between these two variables.
