...
3.  Use a drop-in-deviance test to compare a model that includes only the significant predictors to the full model. Which model do you choose based on the results of this test, which model do you choose as the final model?
...
4.  Does AIC agree with the conclusion from the previous exercise? Does BIC agree?
