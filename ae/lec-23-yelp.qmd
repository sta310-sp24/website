...
-   `length_100`: Number words in the review / 100
...
-   `avg_biz_star`: Average star rating for restaurant
...
Consider the distribution of the respones variable `stars_given`. What type of model(s) can we fit to understand the association between the response and the other factors?
:::
...
What random effect(s) do we need to account for in the model?
:::
...
We will use one of the models from Exercise 4 to draw conclusions about factors associated with a good Yelp review. Which model do choose? Briefly explain your choice.
:::
