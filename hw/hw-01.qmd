...
[^1]: Exercises 1 - 4 are adapted from exercises in Section 1.8 of @roback2021beyond.
...
d.  Fit Model 3, where `price` and `logsqft` (the natural log of sqft) are the response and predictor variables, respectively. How is the price expected to change when sqft increases by 10%? *As a hint, this is the same as multiplying sqft by 1.10.*
