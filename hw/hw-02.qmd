...
-   Use the data to fit a model predicting body mass (which can be difficult to measure) from bill length. Fit the model in a way such that the intercept has a meaningful interpretation.
