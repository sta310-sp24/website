...
::: callout-note
Exercises 1 - 5 were adapted from exercises in chapter 10 of @roback2021beyond.
:::
...
c.  Write the expression for $Cov(Y_{ijk}, Y_{ij'k'})$, the covariance between observations taken at different houses, sold in different time periods from different districts.
