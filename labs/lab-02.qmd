...
-   Use `ntl_airtemp` to create a new data frame `airtemp_avg` containing of the average air temperature by year.
...
::: callout-important
The data frame `ice_air_joined` has 268 observations. You will use `ice_air_joined` for the remainder of this lab.
:::
