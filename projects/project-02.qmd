...
2.  Open a new issue called "Analysis Plan". In the body of the issue add the tag `@sta310-sp24/teaching-team`. <!--# change the tag to my Github username and the TAs. I don't get a notification for teaching-team--> If you have any specific questions you'd like the teaching team to address, add those in the body of the issue as well.
