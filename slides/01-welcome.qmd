...
## Examples of regression in practice - UPDATE THESE?
...
-   Read the [Course Support](https://sta210-fa23.netlify.app/support.html) page for more details
...
-   If you have questions, email [sta210\@duke.edu](mailto: sta210@duke.edu)
...
-   Read about them in the [Academic honesty](https://sta210-fa22.netlify.app/syllabus.html#academic-honesty) section of the syllabus and refer to them as needed

## Use of artificial intelligence (AI) {.midi}

-   You should treat AI tools, such as ChatGPT, the same as other online resources.

-   You may make use of the technology for coding examples on assignments; if you do so, you must explicitly cite where you obtained the code. Any recycled code that is discovered and is not explicitly cited will be treated as plagiarism.

-    Unless instructed otherwise, AI is [**not**]{.underline} permitted for writing narrative on assignments.
...
## Application exercise - UPDATE LINKS IN AE!!!
