...
![Data science life cycle from [R for Data Science](https://r4ds.had.co.nz) with modifications from *The Art of Statistics: How to Learn from Data*.](images/02/data-analysis-life-cycle.png){alt="Data science life cycle from R for Data Science with modifications from The Art of Statistics: How to Learn from Data."}
