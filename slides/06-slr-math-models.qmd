...
::: {.column width="70%"}
![Source: *Introduction to the Practice of Statistics (5th ed)*](images/06/regression.png)
:::
...
The **standard error of** $\hat{\beta}_1$, $SE_{\hat{\beta}_1}$, quantifies the sampling variability in the estimated slopes
...
::: question
Explain what the test statistic means in the context of the data.
:::
...
```{r}
2 * pt(q = 18.17, df = 96, lower.tail = FALSE)
```

::: question
Explain what the p-value means in the context of the data.
:::
