...
-   **Example:** The estimated coefficient for `debt_to_income` is 0.671. This means for each point in an borrower's debt-to-income ratio, the interest rate on the loan is expected to be greater by 0.671%, holding all else constant.
