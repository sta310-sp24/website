---
title: "Proportional odds + Probit regressions"
...
-   `Age`: \[0-14\], \[15-64\], \[65-84\], $\geq$ 85
-   `Arrival mode`: Walk in, Ambulance
-   `Triage level`: Red (urgent), Green (non-urgent)
...
@ibanez2022impact conducted an experiment to understand the impact of watching a nature documentary on pro-environmental behavior. The researchers randomly assigned the 113 participants to watch an video focused about architecture in NYC (control) or a video about Yellowstone National Park (treatment). As part of the experiment, participants were asked to dispose of their headphone coverings in a recycle bin available at the end of the experiment.
...
::: aside
See Section 4.11.2 of @roback2021beyond for more detail.
:::
...
margins(hurdle, variables = "democrat")
```

::: question
Interpret the marginal effect of `democrat` on commenting on at least one issue.
:::
