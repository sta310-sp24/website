...
subtitle: "Variance components model fitting"
...
# fit the model and score the relevant statistics
...
::: question
Read the *Data Analysis* Section in @sadler2010performance. [Click here](https://canvas.duke.edu/courses/25310/files/folder/journal-articles?preview=928557) to access the paper in Canvas. Use the text to answer the following:

1.  What is the goal of the analysis?
2.  What type of model is used? What is the response variable? What is the multilevel structure?
3.  Describe the details of the model estimation.
4.  Describe the data wrangling / creation of new variables. What were the goals of the data wrangling steps?
5.  How as model performance assessed?
:::
...
-   [Click here](https://docs.google.com/presentation/d/1ZtVZst8oJkNrJ0DWl7j_5VsjZc1V40HyxqPPjzA2IPI/edit?usp=sharing) to access the slides.
:::

## Sadler and Miller (2010) Model 1

![](images/12/sadler-miller-2010.png){fig-align="center" width="150%"}
