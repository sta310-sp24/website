...
::: appex
📋 [sta310-sp24.netlify.app/ae/lec-14-longitudinal](https://sta310-sp24.netlify.app/ae/lec-14-longitudinal.html)
:::

<br>

See [BMLR Section 9.3](https://bookdown.org/roback/bookdown-BeyondMLR/ch-lon.html#exploratoryanalysis) for full exploratory data analysis.
...
$$
\begin{aligned}
&a_i = \alpha_0 + u_i \hspace{10mm} b_i = \beta_0 + v_i \\
&\left[ \begin{array}{c}
            u_{i} \\ v_{i}
...
## Notes on drop-in-deviance test {.midi}
