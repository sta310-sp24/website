...
-   Next week:
    ...
    -   (Optional) Project meetings next Nov 20 & 21. [Click here](https://docs.google.com/spreadsheets/d/1EpTge-O1hBDnNy5KW7Y1FoNzIhpLoz4_Xx_nf_FbPgI/edit?usp=sharing) to sign up. Must sign up by Fri, Nov 17
...
-   Therefore, the randomness is not produced by an error term but rather in the Binomial distribution
...
You can then create a plot of the empirical logit versus the mean value of the predictor in each interval.
