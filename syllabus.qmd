...
+========================+=======================================================+=====================+=======================+
| **Instructor**         | [Prof. Maria Tackett](http://stat.duke.edu/~mt324/)   | Mon 10:30 - 11:30am | Old Chem 118B         |
|                        |                                                       |                     |                       |
|                        |                                                       | Wed 1:30 - 2:30pm   |                       |
+------------------------+-------------------------------------------------------+---------------------+-----------------------+
|                        |                                                       | *or by appointment* | Old Chem 118B or Zoom |
+------------------------+-------------------------------------------------------+---------------------+-----------------------+
| **Teaching Assistant** | [Hun Kang](https://www.linkedin.com/in/gyeonghunkang) | Tue 3 - 5pm         | Old Chem 203B         |
+------------------------+-------------------------------------------------------+---------------------+-----------------------+
