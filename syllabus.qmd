...
-   **Use of generative artificial intelligence (AI)**: You should treat use of generative AI, such as ChatGPT, the same as other online resources. You may make use of the technology for coding examples on assignments; if you do so, you must explicitly cite that the code came from ChatGPT. Any recycled code that is discovered and is not explicitly cited will be treated as plagiarism. Unless instructed otherwise, you may not use generative AI to write narrative on assignments. In general, you you may use generative AI as a resource to help as you complete assignments but not a tool to complete the assignments. You are ultimately responsible for the work you turn it in and it should reflect your understanding of the course content.
